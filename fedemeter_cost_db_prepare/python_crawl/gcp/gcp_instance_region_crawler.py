...
class gcp_selenium():
    ...
    def gcp_region_type(self):
        ...
        browser.find_element_by_xpath("//div[@class='devsite-select']/ul[1]/li[2]").click()
        ...
        for i in range(3, 50):
            try:
                ...
                for i in range(len(all_instance_list)):
                    ...
                    elif "m2-ultramem" in temp_list[0] or "m2-megamem" in temp_list[0]:                                 # m2-ultramem-208"4" and the 4 is version number
